...
class FinancialRatioCalculator:
    ...
    def calculate_leverage_ratios(self) -> dict[str, float]:
        ...
        ratios["debt_service_coverage"] = self.safe_divide(
    ...
    def calculate_efficiency_ratios(self) -> dict[str, float]:
        ...
        ratios["days_sales_outstanding"] = self.safe_divide(
            365, ratios["receivables_turnover"]
        )
    ...
    def calculate_valuation_ratios(self) -> dict[str, float]:
        ...
        if earnings_growth > 0:
            ratios["peg_ratio"] = self.safe_divide(
                ratios["pe_ratio"], earnings_growth * 100
            )
